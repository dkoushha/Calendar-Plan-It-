...
! function () {
  ...
  Scheduler.plugin = function (t) {
    ...
    function c() {
      if (void 0 === A) {
        ...
        t.style.position = "absolute", t.style.left = "-9999px", t.style.top = "-9999px",
          t.innerHTML = "<div class='dhx_cal_container'><div class='dhx_cal_scale_placeholder'></div><div>", document.body.appendChild(t);
    ...
    function u() {
      ...
      var t = document.createElement("div");
      t.style.position = "absolute", t.style.left = "-9999px", t.style.top = "-9999px",
        t.innerHTML = "<div class='dhx_cal_container'><div class='dhx_cal_data'><div class='dhx_cal_event'><div class='dhx_body'></div></div><div>", document.body.appendChild(t);
    ...
    g._update_nav_bar = function (t, e) {
      if (t) {
        ...
        null !== b && b === r || (i = !0), x && JSON.stringify(t) === x || (n = !0), i && (g.xy.nav_height = r),
      ...
      g.event(window, "resize", function () {
        t(g._obj) && (window.clearTimeout(g._resize_timer), g._resize_timer = window.setTimeout(function () {
          var a = e();
          if (!i(n, a)) {
            if (!t(g._obj)) return;
            g.callEvent("onSchedulerResize", []) && (g.updateView(), g.callEvent("onAfterSchedulerResize", []))
          }
          n = a
        }, 100))
      }), g._init_once = function () {}
    ...
    g.init = function (t, e, i) {
      ...
      g._render_scales = function (t, e) {
        ...
        if (t && "object" == typeof t) {
          for (a = {}, n = [Array, Date, Number, String, Boolean],
            i = 0; i < n.length; i++) t instanceof n[i] && (a = i ? new n[i](t) : new n[i]);
          e.push(t, a);
    ...
    g.date = {
      ...
      g.set_cover_height = function (t) {
        ...
        i && this._edit_stop_event(i, t), t && g.render_view_data(), this.hideCover(e),
          ...
          n(this._els.dhx_cal_data[0], "touchcancel", s), n(this._els.dhx_cal_data[0], "contextmenu", function (t) {
            ...
            if (!i(t)) {
              ...
              if (!h && !_ && a - u < 250) return g._click.dhx_cal_data(n), window.setTimeout(function () {
                ...
                t.cancelBubble = !0, g._block_next_stop = !0, !1;
              if (u = a, !h && !_ && g.config.touch_drag) {
                ...
                l = setTimeout(function () {
                  ...
                  var t = o.target,
                    e = g._getClassName(t);
                  t && -1 != e.indexOf("dhx_body") && (t = t.previousSibling), g._on_mouse_down(o, t),
            ...
            }, 100)), s(t), g._block_next_stop ? (g._block_next_stop = !1,
      ...
      g.getUserData = function (t, e) {
        ...
        "none" == i.rec_type && (i.rec_pattern = "none"), i.text = i.text || i._tagvalue, i.start_date = g._helpers.parseDate(i.start_date),
